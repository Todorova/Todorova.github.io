        ...
        return (
            <header>
                <nav>
                    ...
                    <NavLink to='/facebook'><img id='facebook' src={FacebookImage} alt="facebook"/> </NavLink>
                    <NavLink to='/github'><img id='github' src={GithubImage} alt="github"/> </NavLink>
                    <NavLink to='/linkedin'><img id='linkedin' src={LinkedinImage} alt="linkedin"/> </NavLink>
                     </nav>
            </header>
        )
    }
